...
% aperture
aper = Aperture( [ 5 0 0 ], [ 10 10 75 75 ] ); % circular aperture
bench.append( aper );
...
% front lens surface
lens1 = Lens( [ 80 0 0 ], 58, 40, -1, { 'air' 'bk7' } ); % parabolic surface
% back lens surface
lens2 = Lens( [ 100 0 0 ], 58, -70, -3, { 'bk7' 'air' } ); % concave hyperbolic surface
bench.append( { lens1, lens2 } );

%bench.rotate( [ 0 0 1 ], 0.15 ); ( r, D, R, k, glass )
