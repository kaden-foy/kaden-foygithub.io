function f = RAYTRACING(x1,r1,w1,x2,r2,w2)
%% Set up parameters
% projector
...
% % lens 2
% x2 = 0.2; % postion of first lens
% r2 = 0.15; % radius of first lens
% w2 = 0.01;% width of first lens
% container wall
...
%% Calculate Light path parameters
rays = rays_through;
